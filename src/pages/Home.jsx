            ...
            >
              <div className="relative flex justify-start items-center">
                <img
                  ...
                  className=""
                />
                <div className="absolute ml-4 sm:ml-8 flex flex-col items-start">
                  <h1 className="uppercase text-text-primary text-sm bg-black inline px-1">
                    suppercharged for pros.
                  </h1>
                  <h1 className="font-bold text-lg sm:text-5xl py-2 sm:py-6">
                    Special Sale
                  </h1>
                  <p>From $999.00 or 41$.62/mo</p>
                  <p>for 24 mo.Footnote</p>
                  <Link className="text-text-primary bg-black text-lg rounded-full px-2 sm:px-4 py-1 sm:py-2 sm:mt-5 mt-2 font-semibold inline-block">
                    Buy Now
                  </Link>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-2 sm:gap-5">
            <div className="overflow-hidden rounded-md flex items-center">
              ...
              <div className="absolute pl-2 sm:pl-4 flex flex-col">
                <p className="text-orange-500 text-sm">BEST SALE</p>
                <h1 className="font-semibold  sm:py-3 text-lg sm:text-2xl">
                  iPad S13+Pro.
                </h1>
                <p className="text-sm">From $999.00</p>
                <p className="text-sm">or $41.66/mo</p>
              </div>
            </div>
            <div className="overflow-hidden rounded-md flex items-center">
              <img
              ...
              />
              <div className="absolute pl-2 sm:pl-4 flex flex-col">
                <p className="text-orange-500 text-sm">NEW ARRIVAL</p>
                <h1 className="font-semibold  sm:py-3 text-lg sm:text-2xl">
                  iPad S13+Pro.
                </h1>
                <p className="text-sm">From $999.00</p>
            ...
            <div className="overflow-hidden rounded-md flex items-center">
              ...
              />
              <div className="absolute pl-2 sm:pl-4 flex flex-col">
                <p className="text-orange-500 text-sm">15% OFF</p>
                <h1 className="font-semibold  sm:py-3 text-lg sm:text-2xl">
                  iPad S13+Pro.
                </h1>
                <p className="text-sm">From $999.00</p>
            ...
            <div className="overflow-hidden rounded-md flex items-center">
              ...
              />
              <div className="absolute pl-2 sm:pl-4 flex flex-col">
                <p className="text-orange-500 text-sm">FREE ENGRAVING</p>
                <h1 className="font-semibold  sm:py-3 text-lg sm:text-2xl">
                  iPad S13+Pro.
                </h1>
                <p className="text-sm">From $999.00</p>
