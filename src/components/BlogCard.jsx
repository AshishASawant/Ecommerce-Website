...
const BlogCard=({item})=>{
    ...
    return (
        <div className="flex gap-4 flex-col jus bg-white rounded-md w-full overflow-hidden blog-card">
              ...
              <div className="sm:p-6 p-2 grid gap-3 ">
                ...
                <Link to={`/blogs/singleblog?${title}`} className="bg-slate-800 text-white sm:px-6 sm:py-3 px-4 py-2 w-fit rounded-3xl">
                  Read More
                </Link>
              </div>
            </div>
